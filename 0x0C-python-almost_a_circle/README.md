...
This project is a review of all Python concepts covered so far, including unittests.

In this project, I created three related classes namely: Base, Rectangle and Square.
